    ...
    <section className="u-center w-full" id="sobreMi">
      ...
      <div>
        <p className="mt-5 text-xl text-start">
          <span className="font-bold">Full Stack Developer,</span> apasionado por
          el desarrollo Frontend ♥️ incursionando  en Backend. Me encanta crear sitios web que brinden una
          ...
          <br />
          Soy una persona autodidacta y apasionada por mi trabajo. Siempre estoy buscando oportunidades para aprender y mejorar mis habilidades. Soy comprometido y responsable en todo lo que hago, y me esfuerzo por alcanzar mis metas profesionales con determinación y perseverancia.
          <br />
